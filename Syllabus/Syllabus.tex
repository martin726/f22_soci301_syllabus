...
see ``COVID Directions'' (above) if you are symptomatic and an in-class
student.
...
week of instruction.
\textcolor{blue}{Each paper must be turned in no later than 11:30 p.m. on the day that it is due.}
...
later than 11:59 p.m. (Pacific Standard Time).}
