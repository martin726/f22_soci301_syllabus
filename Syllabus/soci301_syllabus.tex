...
\item
  ...
  Canvas}. At Chico State, ``this class meets at set days/times
...
you obtain an exemption from the university}.
\textcolor{red}{\bf{CSU Chico is requiring all students who are booster-eligible to certify having received their booster by August 15. Please note that dishonesty relating to the vaccination policy and/or your failure to comply with any other COVID-19 related safety policy or mandate, including the face covering requirement, may result in disciplinary action against you through the office of Student Conduct, Rights and Responsibilities, which can include suspension or expulsion from the California State University system.}}

\hypertarget{masks}{%
\subsection{Masks}\label{masks}}

While masks are not required to attend in-person classrooms, they are
\emph{strongly recommended} at most indoor locations for the fall 2022
semester. Masking is one of the most effective ways to protect yourself
and others, especially indoors. Please continue to respect an
individual's decision to wear a mask even if it is not required. The
professor has chosen to wear a mask during lecture and will take the
necessary steps to provide clearly audible lectures for both in-person
and online students.
...
\subsection{Four (4) Analytical Response Papers (40\% of Final Grade;
10\% each)}\label{writing_assignments}}
...
Papers have a word limit, approximately between 800 to 1000 (roughly 4
...
\item
  ...
  page. This information does not count toward the word count.\\
\item
...
\item
  ...
  Citations do not count toward paper length requirements.
\item
...
\hypertarget{quizzes}{%
\subsection{Quizzes (30\% of Final Grade; 6\% each)}\label{quizzes}}
...
quizzes will be posted electronically after Thursday's class and must be
completed by 11:59 p.m. on the following Friday.} Each quiz will contain
...
your mastery of the theories we are covering in the course.
\textbackslash textcolor\{ForestGreen\{Quizzes are open book and open
notes.
...
annotations and questions are due each Thursday by 11:59 PM. Discussion
posts and annotations will be given credit only if they are substantive
...
\item
  Timeliness: You must complete the reading assignment \textbf{each
...
extra credit critiques should be concise, have a substantive connection
to the course material, and be well-organized and argued; the film
analyses can be submitted at any time during the semester, but no later
than Friday December 9 by 11:59 p.m.}
...
I offer several ways for students to speak with me via Zoom: Wednesday
3:30-4:30 pm office hours These open office hours are first come, first
served, so you may need to wait in the Zoom waiting room if I am
speaking with other students. Need a conversation starter? Ask me about
tea, baking cookies, running, quidditch, yoga, gaming, or chocolate. For
other times, email me to schedule an appointment
...
\textbf{\colorbox{LimeGreen}{Syllabus last updated on August 08, 2022}}}{COURSE SCHEDULE }}\label{course-schedule}}
...
\textbf{Assignment Due:}

\begin{itemize}
\tightlist
\item
  Complete Discussion Board Activity \emph{Favorite Study Space} by
  \textbf{Sunday August 28, by 11:59 p.m.}
\end{itemize}
...
\item
  \textbf{Complete Syllabus Quiz by Friday September 2, by 11:59 p.m.}
\end{itemize}
...
\item
  ...
  \emph{36}(6), 931-960. \colorbox{Goldenrod}{\bf{[E-Posting]}}
\item
  Winant H (2000). ``Race and Race Theory.'' \emph{Annual Review of
  Sociology}, \emph{26}(1), 169-185. \textless URL:
  2022-07-29\textgreater. \colorbox{Goldenrod}{\bf{[E-Posting]}}
\end{itemize}
...
\item
  ...
  of Sociology}, \emph{30}(1), 221-242. \textless URL:
  2022-07-29\textgreater. \colorbox{Goldenrod}{\bf{[E-Posting]}}
\item
  Wilson WJ (2011). ``The Declining Significance of Race: Revisited \&
  Revised.'' \emph{Daedalus}, \emph{140}(2), 55-69.
  \colorbox{Goldenrod}{\bf{[E-Posting]}}
\item
