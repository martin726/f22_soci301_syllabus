...
At the university level, it is a great achievement to earn the grade of A. It is especially worthwhile to earn an A as an overall final course grade. The grade of A is the highest recognition and commendation there is at the university classroom level. Its use in this course will be in that spirit, consistent with the traditional meaning of “excellence.” At the same time, I wish to make it perfectly clear that **your grades in this class are NOT an evaluation of you as a person.** For people on both ends of the grading scale, it is sometimes necessary to remember that you are more than just your grades. 
...
__If this document is updated, a copy will be supplied to you via Blackboard and changes will be announced in class.__
